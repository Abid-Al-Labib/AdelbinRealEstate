  ...
  return (
    ...
    >
        <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-15">
            <h1 className="text-orange-300 pl-0 md:pl-3 mt-10 font-palanquin text-4xl sm:text-8xl  font-bold ">
                <span>Construction Services</span>
                <br />          
            </h1>
                <p className="font-montserrat pl-0 md:pl-5 text-white text-base sm:text-lg leading-8 mt-12 sm:min-w-min">
                    Licensed General Contractor Serving New York City & Nassau County.
                </p>

                <p className="font-montserrat pl-0 md:pl-5 text-white text-base sm:text-lg leading-8 sm:min-w-min">
